...
public class AdminAddBookServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		 ...
		 * 1. 获取真实路径
		 */
		String savepath = this.getServletContext().getRealPath("/img/book_img");
		/*
		 * 2. 创建目标文件
		 */
		 ...
		 * 1. 获取真实路径
		 */
		savepath = this.getServletContext().getRealPath("/img/book_img");
		/*
		 * 2. 创建目标文件
		 */
	...
	private void error(String msg, HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/adminjsps/admin/book/bookIndex.jsp").forward(request, response);
	}
}
