package cn.yjc.bookStore.order.web.servlet;
...
import cn.yjc.bookStore.order.web.servlet.PaymentUtil;
...
public class OrderServlet extends BaseServlet {
	...
	public String paymentPre(HttpServletRequest req, HttpServletResponse resp)
		...
		return "f:/jsps/order/orderPay.jsp";
	}
	/**
	 * 支付方法
	 * @param req
	...
	public String load(HttpServletRequest req, HttpServletResponse resp)
		...
		return "f:/jsps/order/orderDetail.jsp";
	}
	/**
	 * 生成订单
	 * @param req
	...
	public String createOrder(HttpServletRequest req, HttpServletResponse resp)
		...
		/*
		 * 保存订单，转发到ordersuccess.jsp
		 */
		req.setAttribute("order", order);
		return "f:/jsps/order/orderSuccess.jsp";
	}
	/**
	 * 我的订单
	 * @param req
