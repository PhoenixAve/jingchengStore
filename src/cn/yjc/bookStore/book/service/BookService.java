package cn.yjc.bookStore.book.service;

import java.sql.SQLException;
import java.util.List;

import cn.yjc.bookStore.book.dao.BookDao;
...
public class BookService {
	 ...
	 * @return
	 */
	public PageBean<Book> findByPrinttime(String cid) {
		try {
			return bookDao.findByPrinttime(cid);
		} catch (SQLException e) {
			throw new RuntimeException(e);
		}
	}
	 ...
	 * @return
	 */
	public PageBean<Book> findRecommend(int pc) {
		try {
			return bookDao.findRecommend(pc);
		} catch (SQLException e) {
			throw new RuntimeException(e);
		}
	}
