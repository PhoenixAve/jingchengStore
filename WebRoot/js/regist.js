$(function() {
	...
	$("#submitBtn").hover(
		function() {
			$("#submitBtn").attr("src", "/jingchengStore/img/regist2.jpg");
		},
		function() {
			$("#submitBtn").attr("src", "/jingchengStore/img/regist1.jpg");
		}
	);
...
function validateLoginname() {
	 ...
	 */
	$.ajax({
		url:"/jingchengStore/UserServlet",//要请求的servlet
...
function _hyz() {
	 ...
	 * 3. 使用毫秒来添加参数
	 */
	$("#imgVerifyCode").attr("src", "/jingchengStore/VerifyCodeServlet?a=" + new Date().getTime());
}
