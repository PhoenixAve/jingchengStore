...
<html lang="zh-CN">
  <head>
	...
	-->
	<link rel="stylesheet" type="text/css" href="<c:url value='/adminjsps/css/bookList.css'/>" />
  	...
  	<div class="con">
	  	...
	  	<div class="right">
	  		<ul>
				...
				<li>
					<div class="inner">
						<a class="pic" href="<c:url value='/admin/AdminBookServlet?method=load&bid=${book.bid }'/>"><img src="<c:url value='/img/${book.image_b }' />" border="0" /></a>
						<p class="price">
