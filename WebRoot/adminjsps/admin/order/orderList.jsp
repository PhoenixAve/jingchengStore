...
<head>
	...
	<!--
		...
		-->
	<link rel="stylesheet" type="text/css" href="<c:url value='/adminjsps/css/pager.css'/>" />
...
<body>
	...
	<div class="con">
		...
		<div class="divMain">
			<div class="title">
				<div style="padding-top:7px; height: 23px;">
					<span style="display: block; float: left; width: 520px; text-align: center;">商品信息</span>
					<span style="display: block; float: left; width: 195px; text-align: center;">金额</span>
					<span style="display: block; float: left; width: 210px; text-align: center;">订单状态</span>
					<span style="display: block; float: left; width: 272px; text-align: center;">操作</span>
				</div>
			</div>
			<br />
			<table align="center" border="0" width="100%" cellpadding="0" cellspacing="0">
				<c:forEach items="${pb.beanList }" var="order">
					...
					<tr style="padding-top: 10px; padding-bottom: 10px;">
						...
						<td style="padding-left: 0"><span class="price_t">&yen;${order.total }</span></td>
						<td>
							<c:choose>
