...
<html lang="zh-CN">
  <head>
	...
	<link rel="stylesheet" type="text/css" href="<c:url value='/css/orderDetail.css' />" />
  ...
  <body>
	...
	　　　下单时间：${order.ordertime }</span>
			...
			<div class="divContent">
							...
							<table cellpadding="0" cellspacing="0">
								...
								<tr style="padding-top: 20px; padding-bottom: 20px;">
									<td class="td" width="400px">
										<div class="bookname">
											<img align="middle" width="70" src="<c:url value='/img/${item.book.image_b }' />" />
				...
				<div style="margin: 10px 10px 10px 900px;">
